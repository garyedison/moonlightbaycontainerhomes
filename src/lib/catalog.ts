...
> = {
  "white-bungalow": {
    label: "Salt villa",
    finish: "Salt-white two-level containers, charcoal steel frames",
    image: "/homes/white-bungalow.jpg",
  },
  "mint-cottage": {
    label: "Sea-glass villa",
    finish: "Sage container stack, white rail, wrap teak deck",
    image: "/homes/mint-cottage.jpg",
  },
  "teak-lodge": {
    label: "Teak lodge villa",
    finish: "Oiled teak two-level containers, charcoal frames",
    image: "/homes/teak-lodge.jpg",
  },
  elevated: {
    label: "Raised villa",
    finish: "Two-level containers on timber piers, steel stair",
    image: "/homes/elevated.jpg",
  },
  "white-porch": {
    label: "Porch villa",
    finish: "White containers, full-width teak porch",
    image: "/homes/white-porch.jpg",
  },
  "sage-loft": {
    label: "Sage loft villa",
    finish: "Sea-glass cube, roof terrace, steel stair",
    image: "/homes/sage-loft.jpg",
  },
  "teak-linear": {
    label: "Glass bar villa",
    finish: "Linear teak containers, full glass living wall",
    image: "/homes/teak-linear.jpg",
  },
  "teak-l": {
    label: "L-wrap villa",
    finish: "Teak L-plan containers, wrap deck, shed roof",
    image: "/homes/teak-l.jpg",
  },
  "teak-studio": {
    label: "Studio deck villa",
    finish: "Compact teak containers, glass-rail wrap deck",
    image: "/homes/teak-studio.jpg",
  },
  "tiny-loft": {
    label: "Loft container",
    finish: "Compact two-level container with sleeping loft",
...
export const HOMES: Home[] = [
  ...
  home(197, "beach", P21003, "mint-cottage", 252000, "Sea-glass container stack with a small plunge pool."),
  home(198, "beach", P202638, "teak-lodge", 246000, "Oiled teak villa, 8×34 veranda to the sand."),
  home(199, "beach", P202631, "elevated", 255000, "Raised two-level containers, twin stairs to the beach."),

  home(103, "canal", P202611, "white-porch", 198000, "400 sq ft teak deck at the 5 ft canal bank."),
  home(104, "canal", P21009, "teak-lodge", 212000, "Three-bed teak villa, kayak steps to the water."),
  ...
  home(108, "canal-value", P202633, "white-bungalow", 199000, "400 sq ft canal deck, salt-white containers."),
  ...
  home(234, "park", P202621, "white-bungalow", 228000, "Park street, 20×34 salt-white villa."),
  home(235, "park", P202613, "teak-lodge", 232000, "Teak lodge facing the interior street."),
  home(236, "park", P202636, "mint-cottage", 236000, "Two-bath sea-glass villa."),
  home(237, "park", P202621, "elevated", 238000, "Raised containers on park street."),
  home(238, "park", P202613, "white-porch", 226000, "White porch villa, 20×34."),
  home(239, "park", P202636, "teak-linear", 234000, "Glass-bar living wall on the park row."),

  home(241, "street", P202629, "white-porch", 186000, "One-bed porch villa, street view."),
  ...
  home(254, "street", P21030, "white-bungalow", 188000, "16×20 one-bed salt villa."),
  home(255, "street", P21026, "teak-linear", 190000, "Studio-style 16×20, teak glass."),
  home(256, "street", P202620, "teak-lodge", 194000, "20×20 one-bed teak villa."),
  ...
  home(259, "street", P202622, "tiny-loft", 180000, "14×16 loft container, smallest on the street."),

  home(330, "gate", P202611, "white-bungalow", 198000, "First villa inside the gate."),
  ...
  home(169, "gate", P202627, "white-porch", 192000, "Porch villa on the gate road."),
...
export const BANDS: {
...
}[] = [
  {
    ...
    blurb: "The large plans. Four mixed two-level container villas on quarter-acre lots facing the open bay, not the canal.",
